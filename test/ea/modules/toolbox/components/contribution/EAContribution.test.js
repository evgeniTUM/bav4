...
import { MODUS, TYPE } from '../../../../../../src/ea/modules/toolbox/components/contribution/ContributionEnums';
...
describe('EAContributon', () => {
	...
	describe('submit handling', () => {
		...
		it('resets model on back button after submit', async () => {
			...
			expect(element.getModel().type).toEqual(TYPE.REPORT);
