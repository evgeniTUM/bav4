...
describe('i18n for iframe module', () => {
	it('provides translation for de', () => {
		...
		expect(map.iframe_non_embedded_hint).toBe('Die EnergieAtlas-Bayern Iframe API muss über ein Inlineframe-Element eingebunden werden.');
		...
		expect(map.iframe_view_larger_map_chip).toBe('Im EnergieAtlas-Bayern ansehen');
	...
	it('provides translation for en', () => {
		...
		expect(map.iframe_non_embedded_hint).toBe('The EnergieAtlas-Bayern Iframe API must be used in an iframe.');
		...
		expect(map.iframe_view_larger_map_chip).toBe('View in EnergieAtlas-Bayern');
