...
describe('i18n for menu module', () => {
	it('provides translation for de', () => {
		...
		expect(map.toolbox_shareTool_share_link_readonly).toBe('Link zum teilen des Energie-Atlas Bayern');
	...
	it('provides translation for en', () => {
		...
		expect(map.toolbox_shareTool_share_link_readonly).toBe('Link to share Energie-Atlas Bayern');
