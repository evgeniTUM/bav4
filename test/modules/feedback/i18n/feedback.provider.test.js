...
describe('i18n for feedback module', () => {
	it('provides translation for de', () => {
		...
		expect(map.feedback_generalFeedback_rating).toBe('Würden Sie den EnergieAtlas-Bayern weiterempfehlen?');
	...
	it('provides translation for en', () => {
		...
		expect(map.feedback_generalFeedback_rating).toBe('Would you recommend the EnergieAtlas-Bayern?');
