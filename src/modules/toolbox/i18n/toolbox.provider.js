	...
	switch (lang) {
		case 'en':
			return {
				...
				toolbox_shareTool_share_link_readonly: 'Link to share Energie-Atlas Bayern',
		...
		case 'de':
			return {
				...
				toolbox_shareTool_share_link_readonly: 'Link zum teilen des Energie-Atlas Bayern',
