	...
	switch (lang) {
		case 'en':
			return {
				...
				toolbox_shareTool_embed: 'EnergieAtlas-Bayern-IFrame',
				...
				toolbox_shareTool_share_link_readonly: 'Link to share EnergieAtlas-Bayern',
		...
		case 'de':
			return {
				...
				toolbox_shareTool_share_link_readonly: 'Link zum teilen des EnergieAtlas-Bayern',
