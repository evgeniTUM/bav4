	...
	switch (lang) {
		case 'en':
			return {
				...
				feedback_generalFeedback_rating: 'Would you recommend the Energie-Atlas Bayern?',
		...
		case 'de':
			return {
				...
				feedback_generalFeedback_rating: 'Würden Sie den Energie-Atlas Bayern weiterempfehlen?',
