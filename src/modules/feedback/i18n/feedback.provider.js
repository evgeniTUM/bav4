	...
	switch (lang) {
		case 'en':
			return {
				...
				feedback_generalFeedback_could_not_save: 'Your feedback could not be sent',
				feedback_generalFeedback_rating: 'Would you recommend the web mapping platform Energie-Atlas Bayern?',
		...
		case 'de':
			return {
				...
				feedback_saved_successfully: 'Ihr Feedback wurde erfolgreich versendet',
				...
				feedback_generalFeedback_could_not_save: 'Ihr Feedback konnte nicht versendet werden',
				feedback_generalFeedback_rating: 'Würden Sie den Kartenteil des Energie-Atlas Bayern weiterempfehlen?',
