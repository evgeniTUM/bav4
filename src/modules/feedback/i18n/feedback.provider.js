	...
	switch (lang) {
		case 'en':
			return {
				...
				feedback_generalFeedback_rating: 'Would you recommend the EnergieAtlas-Bayern?',
		...
		case 'de':
			return {
				...
				feedback_generalFeedback_rating: 'Würden Sie den EnergieAtlas-Bayern weiterempfehlen?',
