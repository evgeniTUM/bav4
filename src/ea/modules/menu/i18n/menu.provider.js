	...
	switch (lang) {
		case 'en':
			return {
				...
				ea_menu_analyse3d: '3D-Analyse Wind und PV',
				ea_menu_analyse3d_tooltip: 'Hier eine realitätsnahe Darstellung von Windenergie- und PV-Freiflächenanlagen in der Landschaft erstellen',
