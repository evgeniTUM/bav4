...
export class EaProcessEnvConfigService extends ProcessEnvConfigService {
	constructor() {
		...
		this._properties.set('GEOTHERM_CHECK_URL_SONDEN', window?.ba_externalConfigProperties?.GEOTHERM_CHECK_URL_SONDEN ?? process.env.GEOTHERM_CHECK_URL_SONDEN);
		this._properties.set('GEOTHERM_CHECK_URL_KOLLEKTOREN', window?.ba_externalConfigProperties?.GEOTHERM_CHECK_URL_KOLLEKTOREN ?? process.env.GEOTHERM_CHECK_URL_KOLLEKTOREN);
		this._properties.set('GEOTHERM_CHECK_URL_PUMPEN', window?.ba_externalConfigProperties?.GEOTHERM_CHECK_URL_PUMPEN ?? process.env.GEOTHERM_CHECK_URL_PUMPEN);
